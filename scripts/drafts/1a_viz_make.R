# Make visualizations for drafts
...
ggsave(
  ...
  height = 1740,
  units = "px",
  file = here("visualizations/drafts/method_flow_viz.png")
  )
ggsave(
  preproc_flow_viz,
  width = 1787,
  height = 2587,
  units = "px",
  file = here("visualizations/drafts/preproc_flow_viz.png")
  )
ggsave(
  dml_flow_viz_1,
  width = 2587,
  height = 1787,
  units = "px",
  file = here("visualizations/drafts/dml_flow_viz_1.png")
  )
ggsave(
  dml_flow_viz_2,
  width = 2587,
  height = 1787,
  units = "px",
  file = here("visualizations/drafts/dml_flow_viz_2.png")
  )
ggsave(
  pool_flow_viz,
  width = 2587,
  height = 1787,
  units = "px",
  file = here("visualizations/drafts/pool_flow_viz.png")
  )

gtsave(
  appx_a_viz,
  zoom = 5,
  filename = here("visualizations/drafts/appx_a_viz.png")
  )

gtsave(
  appx_b_viz,
  zoom = 5,
  filename = here("visualizations/drafts/appx_b_viz.png")
  )

gtsave(
  appx_c_viz,
  zoom = 5,
  filename = here("visualizations/drafts/appx_c_viz.png")
  )

gtsave(
  appx_d_viz,
  zoom = 5,
  filename = here("visualizations/drafts/appx_d_viz.png")
  )
