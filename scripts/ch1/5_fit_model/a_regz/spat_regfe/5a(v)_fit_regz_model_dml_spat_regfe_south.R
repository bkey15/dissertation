...
# run prep script ----
source(here("scripts/ch1/4_prep_model/a_regz/spat_regfe/4a(v)_prep_regz_model_dml_spat_regfe_south.R"))
...
tictoc_imp_dml_fits_spat_regfe_south <- tic.log()

# save fits ----
imp_dml_fits_spat_regfe_south |> 
  save(file = here("data/ch1/results/fits/dml_regularize/full_dat/imp_dml_fits_spat_regfe_south.rda"))
tictoc_imp_dml_fits_spat_regfe_south |> 
  save(file = here("data/ch1/results/fits/dml_regularize/runtimes/tictoc_imp_dml_fits_spat_regfe_south.rda"))
