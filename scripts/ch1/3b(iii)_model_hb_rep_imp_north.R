...
imp_1968_l1_north <- hb_rep_1968_l1 |> 
  mice::complete(
    action = "long",
    include = TRUE
    ) |> 
...
imp_1977_l1_north <- hb_rep_1977_l1 |> 
  mice::complete(
    action = "long",
    include = TRUE
    ) |> 
...
treat_names_nn_cpr <- hb_rep_1968_l1 |> 
  mice::complete(
    action = "long",
    include = TRUE
    ) |> 
...
treat_names_nn_esr <- hb_rep_1968_l1 |> 
  mice::complete(
    action = "long",
    include = TRUE
    ) |> 
