...
# save ----
imp_2_hb_res_south |> 
  save(file = here("data/ch1/results/fits/hb_rep/mice/start_1968/imp_2_hb_res_south.rda"))
imp_3_hb_res_south |> 
  save(file = here("data/ch1/results/fits/hb_rep/mice/start_1977/imp_3_hb_res_south.rda"))
