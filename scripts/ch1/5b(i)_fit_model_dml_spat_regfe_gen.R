...
# run prep script ----
source(here("scripts/ch1/4b(i)_prep_model_dml_spat_regfe_gen.R"))
...
rm(imp_dml_dats_spat_regfe_gen)
...
imp_dml_fits_spat_regfe_gen |> 
  save(file = here("data/ch1/results/fits/dml_lasso/full_dat/imp_dml_fits_spat_regfe_gen.rda"))
