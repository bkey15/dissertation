...
# load splits ----
load(here("data/ch1/results/splits/spat_cfe/splits_imp_dml_dats_spat_cfe_gen.rda"))
...
# fit models ----
imp_dml_fits_spat_cfe_gen <- list()
interact_stat <- names(imp_dml_dats_spat_cfe_gen)

for(stat in interact_stat){
  list_1a <- imp_dml_dats_spat_cfe_gen[[stat]]
  list_1b <- splits_imp_dml_dats_spat_cfe_gen[[stat]]
...
tictoc_imp_dml_fits_spat_cfe_gen <- tic.log()

# save fits ----
imp_dml_fits_spat_cfe_gen |> 
  save(file = here("data/ch1/results/fits/dml_regularize/full_dat/imp_dml_fits_spat_cfe_gen.rda"))
tictoc_imp_dml_fits_spat_cfe_gen |> 
  save(file = here("data/ch1/results/fits/dml_regularize/runtimes/tictoc_imp_dml_fits_spat_cfe_gen.rda"))
