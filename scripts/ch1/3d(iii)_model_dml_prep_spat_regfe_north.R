...
treat_names_nn_cpr <- imp_sp_t_dfs[[1]][[1]][[1]] |> 
  select(
    starts_with("nn_cpr"),
    -contains(c("pop", "sp_lag"))
    ) |> 
...
treat_names_ns_cpr <- imp_sp_t_dfs[[1]][[1]][[1]] |> 
  select(
    starts_with("ns_cpr"),
    -contains(c("pop", "sp_lag"))
    ) |> 
...
treat_names_nn_esr <- imp_sp_t_dfs[[1]][[1]][[1]] |> 
  select(
    starts_with("nn_esr"),
    -contains(c("pop", "sp_lag"))
    ) |> 
...
treat_names_ns_esr <- imp_sp_t_dfs[[1]][[1]][[1]] |> 
  select(
    starts_with("ns_esr"),
    -contains(c("pop", "sp_lag"))
    ) |> 
...
interact_names_nn_lech <- imp_sp_t_dfs[[1]][[1]][[1]] |> 
  select(
    starts_with("v2x_polyarchy_x_nn_lech"),
    -contains(c("pop", "sp_lag"))
    ) |> 
  names()
...
interact_names_nn_cpr <- imp_sp_t_dfs[[1]][[1]][[1]] |> 
  select(
    starts_with("v2x_polyarchy_x_nn_cpr"),
    -contains(c("pop", "sp_lag"))
    ) |> 
  names()

interact_names_ns_cpr <- imp_sp_t_dfs[[1]][[1]][[1]] |> 
  select(
...
interact_names_nn_esr <- imp_sp_t_dfs[[1]][[1]][[1]] |> 
  select(
    starts_with("v2x_polyarchy_x_nn_esr"),
    -contains(c("pop", "sp_lag"))
    ) |> 
  names()

interact_names_ns_esr <- imp_sp_t_dfs[[1]][[1]][[1]] |> 
  select(
  ...
  for(lag in lag_names){
    ...
    for(i in m){
      ...
      for(j in seq_along(treat_names_nn_cpr)){
        ...
        n <- treat_names_nn_esr[[j]]
        o <- treat_names_ns_esr[[j]]
        p <- interact_names_nn_cpr[[j]]
        q <- interact_names_ns_cpr[[j]]
        r <- interact_names_nn_esr[[j]]
