...
# run prep script ----
source(here("scripts/ch2/3e(ii)_model_dml_prep_spat_regfe_south.R"))
...
imp_dml_fits_spat_regfe_south |> 
  save(file = here("data/ch2/results/fits/dml_lasso/full_dat/imp_dml_fits_spat_regfe_south.rda"))
