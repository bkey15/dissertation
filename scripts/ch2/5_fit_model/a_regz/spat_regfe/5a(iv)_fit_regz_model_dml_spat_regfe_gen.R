...
# run prep script ----
source(here("scripts/ch2/4_prep_model/a_regz/spat_regfe/4a(iv)_prep_regz_model_dml_spat_regfe_gen.R"))
...
imp_dml_fits_spat_regfe_gen |> 
  save(file = here("data/ch2/results/fits/dml_regularize/full_dat/imp_dml_fits_spat_regfe_gen.rda"))
tictoc_imp_dml_fits_spat_regfe_gen |> 
  save(file = here("data/ch2/results/fits/dml_regularize/runtimes/tictoc_imp_dml_fits_spat_regfe_gen.rda"))
