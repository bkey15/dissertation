...
# run prep script ----
source(here("scripts/ch2/4_prep_model/a_regz/spat_regfe/4a(vi)_prep_regz_model_dml_spat_regfe_north.R"))
...
imp_dml_fits_spat_regfe_north |> 
  save(file = here("data/ch2/results/fits/dml_regularize/full_dat/imp_dml_fits_spat_regfe_north.rda"))
tictoc_imp_dml_fits_spat_regfe_north |> 
  save(file = here("data/ch2/results/fits/dml_regularize/runtimes/tictoc_imp_dml_fits_spat_regfe_north.rda"))
