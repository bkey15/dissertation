...
# run prep script ----
source(here("scripts/ch2/4_prep_model/a_regz/2fe/4a(i)_prep_regz_model_dml_2fe_gen.R"))
...
imp_dml_fits_2fe_gen |> 
  save(file = here("data/ch2/results/fits/dml_regularize/full_dat/imp_dml_fits_2fe_gen.rda"))
tictoc_imp_dml_fits_2fe_gen |> 
  save(file = here("data/ch2/results/fits/dml_regularize/runtimes/tictoc_imp_dml_fits_2fe_gen.rda"))
